...
| Proposal decision vocabulary contract | Supported | `docs/standards/proposal-decision-vocabulary.v1.json`; `make proposal-decision-vocabulary-gate` | Advise is the vocabulary authority. Gateway and other consumers validate/project the published pairings; approval-requirement and gate-reason evidence remain separate fields. |
