"""Stable section builders for the generated refactor-health report."""

from __future__ import annotations


def _refactor_health_header() -> list[str]:
    return [
...
def _current_progress_model_and_domain() -> list[str]:
    return [
...
def _current_progress_workflow_and_api() -> list[str]:
    return [
...
def _current_progress_quality_and_runtime() -> list[str]:
    return [
...
def _remaining_enterprise_readiness_work() -> list[str]:
    return [
...
def build_refactor_health_lines() -> list[str]:
    """Compose the report in its stable, reviewable section order."""

    return [
        *_refactor_health_header(),
        *_current_progress_model_and_domain(),
        *_current_progress_workflow_and_api(),
        *_current_progress_quality_and_runtime(),
        *_remaining_enterprise_readiness_work(),
    ]
