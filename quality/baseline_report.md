...
- Generated At: `2026-09-01T15:10:16.867625+00:00`
...
| 8 | `tests/integration/advisory/engine/test_engine_proposal_repository_postgres_integration.py` | 1792 |
...
| 4 | `test_live_postgres_idea_intake_persists_portfolio_scope_for_recovery` | `tests/integration/advisory/engine/test_engine_proposal_repository_postgres_integration.py` | 1315 | 287 |
...
- Radon analyzed block inventory: `5091`
- Radon complexity rank inventory: `A=4959, B=132`
...
- Interrogate docstring inventory: `total=5877, missing=5692, covered=185, coverage=3.1%`
