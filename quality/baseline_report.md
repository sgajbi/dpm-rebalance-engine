...
- Generated At: `2026-08-25T18:33:46.313972+00:00`
...
| 2 | `scripts/validate_cross_service_parity_live.py` | 3523 |
...
| 4 | `_assert_lifecycle_and_delivery_flow` | `scripts/validate_cross_service_parity_live.py` | 1671 | 249 |
| 5 | `_assert_live_proposal_memo_flow` | `scripts/validate_cross_service_parity_live.py` | 2144 | 228 |
| 6 | `test_resolve_stateful_context_with_lotus_core_builds_simulation_request` | `tests/unit/advisory/api/test_lotus_core_stateful_context.py` | 1331 | 225 |
| 7 | `test_proof_pack_indexes_assets_and_blocks_sensitive_committed_material` | `tests/unit/advisory/engine/test_engine_bank_demo_proof_models.py` | 381 | 216 |
...
- Interrogate docstring inventory: `total=5737, missing=5621, covered=116, coverage=2.0%`
