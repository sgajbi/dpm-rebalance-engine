...
- Generated At: `2026-09-04T15:33:40.134125+00:00`
...
| 2 | `tests/unit/advisory/api/test_lotus_core_stateful_context.py` | 2767 |
...
| 5 | `test_resolve_stateful_context_with_lotus_core_builds_simulation_request` | `tests/unit/advisory/api/test_lotus_core_stateful_context.py` | 1393 | 225 |
...
- Radon analyzed block inventory: `5129`
- Radon complexity rank inventory: `A=4998, B=131`
...
- Interrogate docstring inventory: `total=5907, missing=5712, covered=195, coverage=3.3%`
